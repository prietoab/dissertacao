...
Metodologia de estudo: revisão da literatura e aplicação de GA em dois problemas.

Problema 1: ONEMAX, considerado o ``\textit{Hello World}'' dos algoritmos genéticos.

Problema 2: Criação de um robô que foi capaz de vencer os dois campeões do campeonato de Robocode da FT (disciplina de Inteligência Artificial).
